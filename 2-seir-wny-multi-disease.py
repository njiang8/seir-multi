...
INTRO = True # if introduce another thread make the model simulate two thread of disease
...
if __name__ == '__main__':
    ...
    try:
        ...
        seir_saving_path = os.path.join(RESULT_PATH, f"seir_results_multi_r{THREAD_NUM}.csv")
